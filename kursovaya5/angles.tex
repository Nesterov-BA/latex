В данном разделе мы рассмотрим два определения угла облака. Для того,
...
\begin{defin}
  ...
  \)
\end{defin}
% Записать лемму о том, что центр переходит в центр при умножении на
% \lambda не из стационарной группы. Кузен облака [M] -- любое облако
% [\lambda M]. \lambda[M] = [\lambda M]. Оформить все это как лемму.
