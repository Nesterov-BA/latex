...
\end{proof}
\begin{corollary}
  Пространства из теоремы \ref{thrmRUltraMetric} удовлетворяют
  условию теоремы \ref{thrmDist}. Получаем, что расстояние
  Громова--Хаусдорфа между облаками \( [\Delta _1] \) и \( [\R] \)
  равно \( \infty \).
\end{corollary}
